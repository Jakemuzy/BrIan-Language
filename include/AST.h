...
typedef enum NodeType {
    ...
    GEN_FUNC_DECL, GEN_FUNC_DEF, RETURN_TYPE_NODE,
    GEN_FUNC_NODE, REGULAR_FUNC_NODE, 
    PARAM_LIST_NODE, PARAM_NODE,
    LAMBDA_NODE, BODY_NODE,

    // Statements
    RETURN_STMT_NODE, JUMP_STMT_NODE,
    ...
    INTERFACE_DECL_NODE, INTERFACE_BODY_NODE, IMPLEMENTS_NODE,
    ENUM_DECL_NODE, ENUM_BODY_NODE,
    TYPEDEF_DECL_NODE, TYPESPEC_NODE, TYPEDEF_POSTFIX_NODE,

    // Control Flow
    IF_STMT_NODE, IF_NODE ,ELIF_NODE, ELSE_NODE,
    ...
    // Expressions
    TERNARY_EXPR_NODE, ASGN_EXPR_NODE, BINARY_EXPR_NODE, 
    PREFIX_EXPR_NODE, POSTFIX_EXPR_NODE,
    CAST_NODE, INDEX_NODE, CALL_FUNC_NODE, GENERIC_CALL_FUNC_NODE,
    MEMBER_NODE, REF_NODE, SREF_NODE, SMEMBER_NODE,
    EXPR_LIST_NODE,

    // Types
    TYPE_NODE, CHANNEL_NODE, MATRIX_NODE, VECTOR_NODE,
    DECL_PREFIX_NODE, GENERIC_LIST_NODE, GENERIC_NODE, TYPE_LIST_NODE,
    TYPE_QUALIFIER_NODE, FUNC_POINTER_TYPE_QUALIFIER_NODE, QUALIFIER_LIST_NODE,
    LINKAGE_SPECIFIER_NODE, REGISTER_NODE,
    FUNC_POINTER_NODE, CLOSURE_NODE, CAPTURES_NODE,
