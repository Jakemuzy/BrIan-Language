...
typedef enum NodeType {
    ...
    STRUCT_NODE, STRUCT_BODY_NODE, ENUM_NODE, ENUM_BODY_NODE, TYPEDEF_NODE,
    ...
    ASGN_EXPR_NODE, BINARY_EXPR_NODE, UNARY_EXPR_NODE, CALL_FUNC_NODE, ARR_DECL_NODE, ARR_INDEX_NODE, ARR_INIT_NODE,
